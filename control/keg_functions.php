...
function modalViewKeg($prog)
{
global $conn;
?>
  <div class="modal fade" id="viewKegiatan<? echo $prog;?>" tabindex="-1" role="dialog">
    <form id="lap" class="form-horizontal" method="post" enctype="multipart/form-data">
      <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
              <div class="modal-header" style="background-color: #3C8DBC;">
                  <h4 class="modal-title" style="color: white;"><b>DETAIL KEGIATAN</b></h4>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
              </div>
              <div class="modal-body">
                <div class="container-fluid">
                  ...
                  <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane fade show active" id="vtranskeg<? echo $idDetKeg;?>">
                        ...
                        <div class="row">
                          <div class="col col-3 no-gutters" >Pengeluaran</div>
...
function modalDelKeg($prog)
{
global $conn;
?>
  <div class="modal fade" id="delKegiatan<? echo $prog;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
